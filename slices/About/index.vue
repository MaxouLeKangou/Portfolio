...
<template>
  <section ref="contentRef" :data-slice-type="slice.slice_type" :data-slice-variation="slice.variation" class="text-white/75 bg-gray py-24 lg:py-60 grid grid-cols-6 lg:grid-cols-12 gap-3 lg:gap-5">
